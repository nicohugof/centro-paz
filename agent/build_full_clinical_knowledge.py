#!/usr/bin/env python3
"""
Genera agent/blog_clinical_knowledge.py con los 28 artículos clínicos completos.
"""
...
# Agregamos los 14 artículos restantes (15 al 28) con la misma riqueza clínica
code += '''
# Artículos 15 al 28
...
target = ROOT / "agent" / "blog_clinical_knowledge.py"
target.write_text(code, encoding="utf-8")
print(f"✅ Generado exitosamente {target} con los 28 artículos clínicos completos.")
