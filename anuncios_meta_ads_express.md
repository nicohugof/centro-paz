# 🎯 Plan de Anuncios Meta Ads Express — Centro Paz (CPAZ)

Este documento contiene la configuración exacta para lanzar una campaña de anuncios en **Facebook e Instagram Ads** en menos de 5 minutos, diseñada para enviar mensajes directos al WhatsApp **`+56965163893`**.

---

## ⚙️ 1. Configuración de Campaña

* **Objetivo de Campaña:** *Interacción ➡️ Apps de mensajería (WhatsApp directo).*
* **Página de Facebook:** `Centro Paz`
* **Cuenta de Instagram:** `@centropaz.cl`
* **Número de WhatsApp de destino:** `+56 9 6516 3893`
* **Presupuesto Diario Sugerido:** `$3.000 a $5.000 CLP / día` (Total campaña 5 a 7 días: ~$20.000 CLP).

---

## 👥 2. Segmentación de Audiencia (Chile)

* **Ubicaciones:** Chile (Priorizar: Santiago / Región Metropolitana, Valparaíso, Concepción, Antofagasta para sesiones online y presenciales).
* **Edad:** 23 a 48 años.
* **Segmentación por Intereses:**
  - *Intereses:* Salud mental, Psicología, Trastorno por déficit de atención con hiperactividad (TDAH), Autismo, Crianza, Bienestar emocional.
* **Ubicaciones del anuncio:** *Placements automáticos (Advantage+)* o manuales (Feed de Instagram, Stories de Instagram, Feed de Facebook).

---

## 🎨 3. Tres Variaciones de Anuncios Listos para Usar

### 📌 Anuncio A: Gancho TDAH / Neurodivergencias en Adultos (Mayor conversión)
* **Imagen:** [`assets/instagram/post_01_tdah_adultos.png`](file:///Users/nigoku/CPAZ/assets/instagram/post_01_tdah_adultos.png)
* **Texto Principal:**
  ```text
  ¿Sientes que vives con una sobrecarga mental constante o que te cuesta horrores empezar tareas cotidianas? 🧠✨

  Muchas personas adultas descubren su neurodivergencia (TDAH o TEA) después de los 25 años tras décadas de sentirse "diferentes" o agotadas por sobreexigirse.
  ...
  ```
* **Titular del Anuncio:** *Atención Psicológica · TDAH y TEA en Adultos*
* **Botón CTA:** *Enviar mensaje de WhatsApp*

---

### 📌 Anuncio B: Derribador de Barrera Económica (Reembolso Isapre)
* **Imagen:** [`assets/instagram/post_02_reembolso_isapre.png`](file:///Users/nigoku/CPAZ/assets/instagram/post_02_reembolso_isapre.png)
* **Texto Principal:**
  ```text
  ¿Sabías que puedes atenderte con psicóloga clínica y reembolsar entre el 50% y el 80% de cada sesión? 🌿💳

  En Centro Paz emitimos boletas electrónicas de honorarios profesionales válidas para:
  ✨ Todas las Isapres (Colmena, Banmédica, CruzBlanca, Consalud, Vida Tres, etc.).
  ...
  ```
* **Titular del Anuncio:** *Psicoterapia con Reembolso Isapre en 3 Pasos*
* **Botón CTA:** *Enviar mensaje de WhatsApp*

---

### 📌 Anuncio C: Crianza Respetuosa & Familias (Para Padres)
* **Imagen:** [`assets/instagram/post_03_crianza_regulacion.png`](file:///Users/nigoku/CPAZ/assets/instagram/post_03_crianza_regulacion.png)
* **Texto Principal:**
  ```text
  ¿Tu hijo/a experimenta desbordes emocionales frecuentes o sospechas de desafíos de atención/sensoriales? 🌱

  Criar no tiene por qué ser una experiencia de constante tensión. En Centro Paz acompañamos a niños y adolescentes, y brindamos orientación continua a padres para implementar pautas respetuosas y efectivas en el hogar.

  🌿 Espacio lúdico y de contención emocional.
  🌿 Pautas claras para el manejo de frustración y rutinas.
  💳 Boletas reembolsables en Isapres y Seguros.

  👇 Escríbenos por WhatsApp para coordinar una primera consulta de orientación.
  ```
